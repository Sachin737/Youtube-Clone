...
const Header = () => {
  ...
  const { loading, mobileMenu, setMobileMenu } = useContext(LevelContext);
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black">
      ...
      <div className="group flex items-center">
        ...
        <button className="w-[40px] md:w-[60px] h-[32px] md:h-[40px] lg:h-[40px] flex items-center justify-center border border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]">
