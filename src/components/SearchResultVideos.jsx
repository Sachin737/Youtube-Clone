...
const SearchResultVideos = ({ video }) => {
  return (
    <Link to={`/video/${video.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-2 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
          <span className="text-lg md:text-1xl line-clamp-2 text-white font-normal">
            {video?.title}
          </span>
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex text-sm font-light text-white/[0.7] truncate overflow-hidden">
